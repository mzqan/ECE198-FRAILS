...
/* USER CODE BEGIN PV */
float sendData = 25.35; // Example float data to send
/* USER CODE END PV */
...
int main(void)
{
  ...
  while (1)
  {
    ...
    HAL_UART_Transmit(&huart2, (uint8_t *)&sendData, sizeof(sendData), HAL_MAX_DELAY);
    HAL_Delay(1000); // Send data every 1 second
    /* USER CODE END WHILE */
